...
export default function DataManiAndVisuPage({ closeDataManiAndVisu, Done }) {
    const Nexthandler = () => {
        Done();
        closeDataManiAndVisu();
    }
        ...
        <section className={`transition-transform duration-300 ease-in-out fixed right-0 ${isFullScreen} top-0 bottom-0 overflow-y-scroll scrollbar scrollbar-thumb-scrollbarThumb scrollbar-track-scrollbarTrack scrollbar-bg-scrollbarBg inset-0 bg-[#0e1542] flex justify-center items-center z-50 m-0 h-[100%] pt-6`} style={{ boxShadow: "0 0 10px 0px #000000" }}>
            <div className="bg-[#0e1542] text-white pb-0 px-4 h-[100%]">
                <div className='flex pb-4 justify-between items-center w-[100%]'>
                    ...
                    <span onClick={closeDataManiAndVisu} className="material-symbols-outlined text-[#8f8f8f] cursor-pointer">
                        close
                    </span>
                </div>
                <h2 className="text-2xl mb-4 bg-[#00d9ff] text-black w-[100%] rounded-md p-2">Data Manipulation & Visualization</h2>
                <div className="flex flex-col gap-1">
                    <p><span className="text-[#23daff] font-bold">Data Manipulation & Visualization</span> are crucial skills in AI/ML development. They involve preparing and analyzing data to extract meaningful insights and present them in an understandable format.</p>
                    ...
                    <div className="flex flex-col my-5 gap-4">
                        ...
                        <p className="font-bold">Resources to become an expert in Data Manipulation & Visualization:</p>
                ...
                <div className="flex justify-between">
                    <button onClick={closeDataManiAndVisu} className="px-4 py-2 bg-blue-600 text-white rounded">Close</button>
