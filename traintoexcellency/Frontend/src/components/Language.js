...
import c_sharp from '../images/LanguageImage/C(Sharp).jpg'
import java from '../images/LanguageImage/java.jpg'
import rust from '../images/LanguageImage/rust.png'
import typesript from '../images/LanguageImage/typescript.png'
import SQL from '../images/LanguageImage/SQL.jpg'
import Go from '../images/LanguageImage/go.jpg'
import php from '../images/LanguageImage/php.jpg'
import Javasript from '../images/LanguageImage/JavaScript.png'
import Flutter from '../images/LanguageImage/flutter.png'
import solidity from '../images/LanguageImage/solidity.jpg'
        ...
        <section className="flex flex-col w-[80%] h-[100%] gap-4">
            ...
            <div className='flex flex-col p-4 gap-8'>
                ...
                <div className='language-container flex flex-wrap gap-6 py-4 border-t-2'>
                    <div className="c_language flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className=" cplusplus flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="python flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="c_sharp flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="rust flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="java flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="SQL flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="javascript flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="typescript flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="Solidity flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="go flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="php flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
                    ...
                    <div className="flutter flex flex-col gap-2 w-[30%] min-h-48 bg-gray-500 items-center py-2 border-0 rounded-lg">
